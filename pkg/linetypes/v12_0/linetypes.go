...
type MTD_2DSINGLE struct {
	util.VxMetadata
	MTD_2DSINGLE_header
	Data map[string]MTD_2DSINGLE_data `json:"data"` //nolint:tagliatelle
}
...
type MTD_3DPAIR struct {
	util.VxMetadata
	MTD_3DPAIR_header
	Data map[string]MTD_3DPAIR_data `json:"data"` //nolint:tagliatelle
}
...
type MTD_3DSINGLE struct {
	util.VxMetadata
	MTD_3DSINGLE_header
	Data map[string]MTD_3DSINGLE_data `json:"data"` //nolint:tagliatelle
}
