...
// Adds a new "data" element to MTD_2DSINGLE
func (doc *MTD_2DSINGLE) AddDataElement(dataKey string, dataData []string) error {
	data := MTD_2DSINGLE_data{}
	if err := data.fill(dataData); err != nil {
		return err
	}
	doc.Data[dataKey] = data
...
// Adds a new "data" element to MTD_3DPAIR
func (doc *MTD_3DPAIR) AddDataElement(dataKey string, dataData []string) error {
	data := MTD_3DPAIR_data{}
	if err := data.fill(dataData); err != nil {
		return err
	}
	doc.Data[dataKey] = data
...
// Adds a new "data" element to MTD_3DSINGLE
func (doc *MTD_3DSINGLE) AddDataElement(dataKey string, dataData []string) error {
	data := MTD_3DSINGLE_data{}
	if err := data.fill(dataData); err != nil {
		return err
	}
	doc.Data[dataKey] = data
...
func (s *MTD_2DSINGLE_header) fill(fields []string) error {
	var errs []error
	appendErrorWithContext(&errs, "VERSION", s.VERSION.UnmarshalText([]byte(fields[0])))
	appendErrorWithContext(&errs, "MODEL", s.MODEL.UnmarshalText([]byte(fields[1])))
	appendErrorWithContext(&errs, "DESC", s.DESC.UnmarshalText([]byte(fields[2])))
	appendErrorWithContext(&errs, "FCST_LEAD", s.FCST_LEAD.UnmarshalText([]byte(fields[3])))
	appendErrorWithContext(&errs, "FCST_VALID", s.FCST_VALID.UnmarshalText([]byte(fields[4])))
	appendErrorWithContext(&errs, "OBS_LEAD", s.OBS_LEAD.UnmarshalText([]byte(fields[5])))
	appendErrorWithContext(&errs, "OBS_VALID", s.OBS_VALID.UnmarshalText([]byte(fields[6])))
	appendErrorWithContext(&errs, "T_DELTA", s.T_DELTA.UnmarshalText([]byte(fields[7])))
	appendErrorWithContext(&errs, "FCST_T_BEG", s.FCST_T_BEG.UnmarshalText([]byte(fields[8])))
	appendErrorWithContext(&errs, "FCST_T_END", s.FCST_T_END.UnmarshalText([]byte(fields[9])))
	appendErrorWithContext(&errs, "FCST_RAD", s.FCST_RAD.UnmarshalText([]byte(fields[10])))
	appendErrorWithContext(&errs, "FCST_THR", s.FCST_THR.UnmarshalText([]byte(fields[11])))
	appendErrorWithContext(&errs, "OBS_T_BEG", s.OBS_T_BEG.UnmarshalText([]byte(fields[12])))
	appendErrorWithContext(&errs, "OBS_T_END", s.OBS_T_END.UnmarshalText([]byte(fields[13])))
	appendErrorWithContext(&errs, "OBS_RAD", s.OBS_RAD.UnmarshalText([]byte(fields[14])))
	appendErrorWithContext(&errs, "OBS_THR", s.OBS_THR.UnmarshalText([]byte(fields[15])))
	appendErrorWithContext(&errs, "FCST_VAR", s.FCST_VAR.UnmarshalText([]byte(fields[16])))
	appendErrorWithContext(&errs, "FCST_UNITS", s.FCST_UNITS.UnmarshalText([]byte(fields[17])))
	appendErrorWithContext(&errs, "FCST_LEV", s.FCST_LEV.UnmarshalText([]byte(fields[18])))
	appendErrorWithContext(&errs, "OBS_VAR", s.OBS_VAR.UnmarshalText([]byte(fields[19])))
	appendErrorWithContext(&errs, "OBS_UNITS", s.OBS_UNITS.UnmarshalText([]byte(fields[20])))
	appendErrorWithContext(&errs, "OBS_LEV", s.OBS_LEV.UnmarshalText([]byte(fields[21])))
	appendErrorWithContext(&errs, "LINE_TYPE", s.LINE_TYPE.UnmarshalText([]byte("MTD_2DSINGLE"))) // hardcode the LINE_TYPE - it doesn't exist in the stat file fields
	return errors.Join(errs...)
}

// Sets MTD_3DPAIR_header struct's fields
func (s *MTD_3DPAIR_header) fill(fields []string) error {
	var errs []error
	appendErrorWithContext(&errs, "VERSION", s.VERSION.UnmarshalText([]byte(fields[0])))
	appendErrorWithContext(&errs, "MODEL", s.MODEL.UnmarshalText([]byte(fields[1])))
	appendErrorWithContext(&errs, "DESC", s.DESC.UnmarshalText([]byte(fields[2])))
	...
	appendErrorWithContext(&errs, "OBS_UNITS", s.OBS_UNITS.UnmarshalText([]byte(fields[20])))
	appendErrorWithContext(&errs, "OBS_LEV", s.OBS_LEV.UnmarshalText([]byte(fields[21])))
	appendErrorWithContext(&errs, "LINE_TYPE", s.LINE_TYPE.UnmarshalText([]byte("MTD_3DPAIR"))) // hardcode the LINE_TYPE - it doesn't exist in the stat file fields
	return errors.Join(errs...)
}

// Sets MTD_3DSINGLE_header struct's fields
func (s *MTD_3DSINGLE_header) fill(fields []string) error {
	var errs []error
	appendErrorWithContext(&errs, "VERSION", s.VERSION.UnmarshalText([]byte(fields[0])))
	appendErrorWithContext(&errs, "MODEL", s.MODEL.UnmarshalText([]byte(fields[1])))
	appendErrorWithContext(&errs, "DESC", s.DESC.UnmarshalText([]byte(fields[2])))
	...
	appendErrorWithContext(&errs, "OBS_UNITS", s.OBS_UNITS.UnmarshalText([]byte(fields[20])))
	appendErrorWithContext(&errs, "OBS_LEV", s.OBS_LEV.UnmarshalText([]byte(fields[21])))
	appendErrorWithContext(&errs, "LINE_TYPE", s.LINE_TYPE.UnmarshalText([]byte("MTD_3DSINGLE"))) // hardcode the LINE_TYPE - it doesn't exist in the stat file fields
	return errors.Join(errs...)
}
...
func (s *STAT_SEEPS_MPR_header) fill(fields []string) error {
	var errs []error
	appendErrorWithContext(&errs, "VERSION", s.VERSION.UnmarshalText([]byte(fields[0])))
	appendErrorWithContext(&errs, "MODEL", s.MODEL.UnmarshalText([]byte(fields[1])))
	appendErrorWithContext(&errs, "DESC", s.DESC.UnmarshalText([]byte(fields[2])))
...
func (s *STAT_SEEPS_header) fill(fields []string) error {
	var errs []error
	appendErrorWithContext(&errs, "VERSION", s.VERSION.UnmarshalText([]byte(fields[0])))
	appendErrorWithContext(&errs, "MODEL", s.MODEL.UnmarshalText([]byte(fields[1])))
	appendErrorWithContext(&errs, "DESC", s.DESC.UnmarshalText([]byte(fields[2])))
...
func (s *TCST_TCDIAG_header) fill(fields []string) error {
	var errs []error
	appendErrorWithContext(&errs, "VERSION", s.VERSION.UnmarshalText([]byte(fields[0])))
	appendErrorWithContext(&errs, "AMODEL", s.AMODEL.UnmarshalText([]byte(fields[1])))
	appendErrorWithContext(&errs, "BMODEL", s.BMODEL.UnmarshalText([]byte(fields[2])))
...
type STAT_MPR_data struct {
	...
	OBS_CLIMO_MEAN   validtypes.ValidString `json:"OBS_CLIMO_MEAN,omitzero"`
...
func (s *MODE_CTS_data) fill(fields []string) error {
	...
	appendErrorWithContext(&errs, "LODDS", s.LODDS.UnmarshalText([]byte(fields[19])))
	appendErrorWithContext(&errs, "ORSS", s.ORSS.UnmarshalText([]byte(fields[20])))
	appendErrorWithContext(&errs, "EDS", s.EDS.UnmarshalText([]byte(fields[21])))
	appendErrorWithContext(&errs, "SEDS", s.SEDS.UnmarshalText([]byte(fields[22])))
	appendErrorWithContext(&errs, "EDI", s.EDI.UnmarshalText([]byte(fields[23])))
	appendErrorWithContext(&errs, "SEDI", s.SEDI.UnmarshalText([]byte(fields[24])))
	appendErrorWithContext(&errs, "BAGSS", s.BAGSS.UnmarshalText([]byte(fields[25])))
	return errors.Join(errs...)
}
...
func (s *MTD_2DSINGLE_data) fill(fields []string) error {
	var errs []error
	appendErrorWithContext(&errs, "OBJECT_ID", s.OBJECT_ID.UnmarshalText([]byte(fields[0])))
	appendErrorWithContext(&errs, "OBJECT_CAT", s.OBJECT_CAT.UnmarshalText([]byte(fields[1])))
	appendErrorWithContext(&errs, "TIME_INDEX", s.TIME_INDEX.UnmarshalText([]byte(fields[2])))
	appendErrorWithContext(&errs, "AREA", s.AREA.UnmarshalText([]byte(fields[3])))
	appendErrorWithContext(&errs, "CENTROID_X", s.CENTROID_X.UnmarshalText([]byte(fields[4])))
	appendErrorWithContext(&errs, "CENTROID_Y", s.CENTROID_Y.UnmarshalText([]byte(fields[5])))
	appendErrorWithContext(&errs, "CENTROID_LAT", s.CENTROID_LAT.UnmarshalText([]byte(fields[6])))
	appendErrorWithContext(&errs, "CENTROID_LON", s.CENTROID_LON.UnmarshalText([]byte(fields[7])))
	appendErrorWithContext(&errs, "AXIS_ANG", s.AXIS_ANG.UnmarshalText([]byte(fields[8])))
	appendErrorWithContext(&errs, "INTENSITY_10", s.INTENSITY_10.UnmarshalText([]byte(fields[9])))
	appendErrorWithContext(&errs, "INTENSITY_25", s.INTENSITY_25.UnmarshalText([]byte(fields[10])))
	appendErrorWithContext(&errs, "INTENSITY_50", s.INTENSITY_50.UnmarshalText([]byte(fields[11])))
	appendErrorWithContext(&errs, "INTENSITY_75", s.INTENSITY_75.UnmarshalText([]byte(fields[12])))
	appendErrorWithContext(&errs, "INTENSITY_90", s.INTENSITY_90.UnmarshalText([]byte(fields[13])))
	appendErrorWithContext(&errs, "INTENSITY_USER", s.INTENSITY_USER.UnmarshalText([]byte(fields[14])))
	return errors.Join(errs...)
}

// Sets MTD_3DPAIR_data struct's fields
func (s *MTD_3DPAIR_data) fill(fields []string) error {
	var errs []error
	appendErrorWithContext(&errs, "OBJECT_ID", s.OBJECT_ID.UnmarshalText([]byte(fields[0])))
	appendErrorWithContext(&errs, "OBJECT_CAT", s.OBJECT_CAT.UnmarshalText([]byte(fields[1])))
	appendErrorWithContext(&errs, "SPACE_CENTROID_DIST", s.SPACE_CENTROID_DIST.UnmarshalText([]byte(fields[2])))
	appendErrorWithContext(&errs, "TIME_CENTROID_DELTA", s.TIME_CENTROID_DELTA.UnmarshalText([]byte(fields[3])))
	appendErrorWithContext(&errs, "AXIS_DIFF", s.AXIS_DIFF.UnmarshalText([]byte(fields[4])))
	appendErrorWithContext(&errs, "SPEED_DELTA", s.SPEED_DELTA.UnmarshalText([]byte(fields[5])))
	appendErrorWithContext(&errs, "DIRECTION_DIFF", s.DIRECTION_DIFF.UnmarshalText([]byte(fields[6])))
	appendErrorWithContext(&errs, "VOLUME_RATIO", s.VOLUME_RATIO.UnmarshalText([]byte(fields[7])))
	appendErrorWithContext(&errs, "START_TIME_DELTA", s.START_TIME_DELTA.UnmarshalText([]byte(fields[8])))
	appendErrorWithContext(&errs, "END_TIME_DELTA", s.END_TIME_DELTA.UnmarshalText([]byte(fields[9])))
	appendErrorWithContext(&errs, "INTERSECTION_VOLUME", s.INTERSECTION_VOLUME.UnmarshalText([]byte(fields[10])))
	appendErrorWithContext(&errs, "DURATION_DIFF", s.DURATION_DIFF.UnmarshalText([]byte(fields[11])))
	appendErrorWithContext(&errs, "INTEREST", s.INTEREST.UnmarshalText([]byte(fields[12])))
	return errors.Join(errs...)
}

// Sets MTD_3DSINGLE_data struct's fields
func (s *MTD_3DSINGLE_data) fill(fields []string) error {
	var errs []error
	appendErrorWithContext(&errs, "OBJECT_ID", s.OBJECT_ID.UnmarshalText([]byte(fields[0])))
	appendErrorWithContext(&errs, "OBJECT_CAT", s.OBJECT_CAT.UnmarshalText([]byte(fields[1])))
	appendErrorWithContext(&errs, "CENTROID_X", s.CENTROID_X.UnmarshalText([]byte(fields[2])))
	appendErrorWithContext(&errs, "CENTROID_Y", s.CENTROID_Y.UnmarshalText([]byte(fields[3])))
	appendErrorWithContext(&errs, "CENTROID_T", s.CENTROID_T.UnmarshalText([]byte(fields[4])))
	appendErrorWithContext(&errs, "CENTROID_LAT", s.CENTROID_LAT.UnmarshalText([]byte(fields[5])))
	appendErrorWithContext(&errs, "CENTROID_LON", s.CENTROID_LON.UnmarshalText([]byte(fields[6])))
	appendErrorWithContext(&errs, "X_DOT", s.X_DOT.UnmarshalText([]byte(fields[7])))
	appendErrorWithContext(&errs, "Y_DOT", s.Y_DOT.UnmarshalText([]byte(fields[8])))
	appendErrorWithContext(&errs, "AXIS_ANG", s.AXIS_ANG.UnmarshalText([]byte(fields[9])))
	appendErrorWithContext(&errs, "VOLUME", s.VOLUME.UnmarshalText([]byte(fields[10])))
	appendErrorWithContext(&errs, "START_TIME", s.START_TIME.UnmarshalText([]byte(fields[11])))
	appendErrorWithContext(&errs, "END_TIME", s.END_TIME.UnmarshalText([]byte(fields[12])))
	appendErrorWithContext(&errs, "CDIST_TRAVELLED", s.CDIST_TRAVELLED.UnmarshalText([]byte(fields[13])))
	appendErrorWithContext(&errs, "INTENSITY_10", s.INTENSITY_10.UnmarshalText([]byte(fields[14])))
	appendErrorWithContext(&errs, "INTENSITY_25", s.INTENSITY_25.UnmarshalText([]byte(fields[15])))
	appendErrorWithContext(&errs, "INTENSITY_50", s.INTENSITY_50.UnmarshalText([]byte(fields[16])))
	appendErrorWithContext(&errs, "INTENSITY_75", s.INTENSITY_75.UnmarshalText([]byte(fields[17])))
	appendErrorWithContext(&errs, "INTENSITY_90", s.INTENSITY_90.UnmarshalText([]byte(fields[18])))
	appendErrorWithContext(&errs, "INTENSITY_USER", s.INTENSITY_USER.UnmarshalText([]byte(fields[19])))
	return errors.Join(errs...)
}
...
func (s *STAT_CTC_data) fill(fields []string) error {
	...
	appendErrorWithContext(&errs, "EC_VALUE", s.EC_VALUE.UnmarshalText([]byte(fields[5])))
	return errors.Join(errs...)
}
...
func (s *STAT_CTS_data) fill(fields []string) error {
	...
	appendErrorWithContext(&errs, "HSS_EC", s.HSS_EC.UnmarshalText([]byte(fields[93])))
	appendErrorWithContext(&errs, "HSS_EC_BCL", s.HSS_EC_BCL.UnmarshalText([]byte(fields[94])))
	appendErrorWithContext(&errs, "HSS_EC_BCU", s.HSS_EC_BCU.UnmarshalText([]byte(fields[95])))
	appendErrorWithContext(&errs, "EC_VALUE", s.EC_VALUE.UnmarshalText([]byte(fields[96])))
	return errors.Join(errs...)
}
...
func (s *STAT_ECNT_data) fill(fields []string) error {
	...
	appendErrorWithContext(&errs, "CRPS_EMP_FAIR", s.CRPS_EMP_FAIR.UnmarshalText([]byte(fields[16])))
	appendErrorWithContext(&errs, "SPREAD_MD", s.SPREAD_MD.UnmarshalText([]byte(fields[17])))
	appendErrorWithContext(&errs, "MAE", s.MAE.UnmarshalText([]byte(fields[18])))
	appendErrorWithContext(&errs, "MAE_OERR", s.MAE_OERR.UnmarshalText([]byte(fields[19])))
	appendErrorWithContext(&errs, "BIAS_RATIO", s.BIAS_RATIO.UnmarshalText([]byte(fields[20])))
	appendErrorWithContext(&errs, "N_GE_OBS", s.N_GE_OBS.UnmarshalText([]byte(fields[21])))
	appendErrorWithContext(&errs, "ME_GE_OBS", s.ME_GE_OBS.UnmarshalText([]byte(fields[22])))
	appendErrorWithContext(&errs, "N_LT_OBS", s.N_LT_OBS.UnmarshalText([]byte(fields[23])))
	appendErrorWithContext(&errs, "ME_LT_OBS", s.ME_LT_OBS.UnmarshalText([]byte(fields[24])))
	appendErrorWithContext(&errs, "IGN_CONV_OERR", s.IGN_CONV_OERR.UnmarshalText([]byte(fields[25])))
	appendErrorWithContext(&errs, "IGN_CORR_OERR", s.IGN_CORR_OERR.UnmarshalText([]byte(fields[26])))
	return errors.Join(errs...)
}
...
func (s *STAT_MPR_data) fill(fields []string) error {
	...
	appendErrorWithContext(&errs, "OBS_CLIMO_MEAN", s.OBS_CLIMO_MEAN.UnmarshalText([]byte(fields[10])))
	appendErrorWithContext(&errs, "OBS_CLIMO_STDEV", s.OBS_CLIMO_STDEV.UnmarshalText([]byte(fields[11])))
	appendErrorWithContext(&errs, "OBS_CLIMO_CDF", s.OBS_CLIMO_CDF.UnmarshalText([]byte(fields[12])))
	appendErrorWithContext(&errs, "FCST_CLIMO_MEAN", s.FCST_CLIMO_MEAN.UnmarshalText([]byte(fields[13])))
	appendErrorWithContext(&errs, "FCST_CLIMO_STDEV", s.FCST_CLIMO_STDEV.UnmarshalText([]byte(fields[14])))
	return errors.Join(errs...)
}
...
func (s *STAT_ORANK_data) fill(fields []string) error {
	...
	appendErrorWithContext(&errs, "OBS_CLIMO_MEAN", s.OBS_CLIMO_MEAN.UnmarshalText([]byte(fields[15])))
	...
	appendErrorWithContext(&errs, "OBS_CLIMO_STDEV", s.OBS_CLIMO_STDEV.UnmarshalText([]byte(fields[20])))
	appendErrorWithContext(&errs, "FCST_CLIMO_MEAN", s.FCST_CLIMO_MEAN.UnmarshalText([]byte(fields[21])))
	appendErrorWithContext(&errs, "FCST_CLIMO_STDEV", s.FCST_CLIMO_STDEV.UnmarshalText([]byte(fields[22])))
	return errors.Join(errs...)
}
...
func (s *STAT_SEEPS_MPR_data) fill(fields []string) error {
	var errs []error
	appendErrorWithContext(&errs, "OBS_SID", s.OBS_SID.UnmarshalText([]byte(fields[0])))
	appendErrorWithContext(&errs, "OBS_LAT", s.OBS_LAT.UnmarshalText([]byte(fields[1])))
	appendErrorWithContext(&errs, "OBS_LON", s.OBS_LON.UnmarshalText([]byte(fields[2])))
	appendErrorWithContext(&errs, "FCST", s.FCST.UnmarshalText([]byte(fields[3])))
	appendErrorWithContext(&errs, "OBS", s.OBS.UnmarshalText([]byte(fields[4])))
	appendErrorWithContext(&errs, "OBS_QC", s.OBS_QC.UnmarshalText([]byte(fields[5])))
	appendErrorWithContext(&errs, "FCST_CAT", s.FCST_CAT.UnmarshalText([]byte(fields[6])))
	appendErrorWithContext(&errs, "OBS_CAT", s.OBS_CAT.UnmarshalText([]byte(fields[7])))
	appendErrorWithContext(&errs, "P1", s.P1.UnmarshalText([]byte(fields[8])))
	appendErrorWithContext(&errs, "P2", s.P2.UnmarshalText([]byte(fields[9])))
	appendErrorWithContext(&errs, "T1", s.T1.UnmarshalText([]byte(fields[10])))
	appendErrorWithContext(&errs, "T2", s.T2.UnmarshalText([]byte(fields[11])))
	appendErrorWithContext(&errs, "SEEPS", s.SEEPS.UnmarshalText([]byte(fields[12])))
	return errors.Join(errs...)
}

// Sets STAT_SEEPS_data struct's fields
func (s *STAT_SEEPS_data) fill(fields []string) error {
	var errs []error
	appendErrorWithContext(&errs, "TOTAL", s.TOTAL.UnmarshalText([]byte(fields[0])))
	appendErrorWithContext(&errs, "ODFL", s.ODFL.UnmarshalText([]byte(fields[1])))
	appendErrorWithContext(&errs, "ODFH", s.ODFH.UnmarshalText([]byte(fields[2])))
	appendErrorWithContext(&errs, "OLFD", s.OLFD.UnmarshalText([]byte(fields[3])))
	appendErrorWithContext(&errs, "OLFH", s.OLFH.UnmarshalText([]byte(fields[4])))
	appendErrorWithContext(&errs, "OHFD", s.OHFD.UnmarshalText([]byte(fields[5])))
	appendErrorWithContext(&errs, "OHFL", s.OHFL.UnmarshalText([]byte(fields[6])))
	appendErrorWithContext(&errs, "PF1", s.PF1.UnmarshalText([]byte(fields[7])))
	appendErrorWithContext(&errs, "PF2", s.PF2.UnmarshalText([]byte(fields[8])))
	appendErrorWithContext(&errs, "PF3", s.PF3.UnmarshalText([]byte(fields[9])))
	appendErrorWithContext(&errs, "PV1", s.PV1.UnmarshalText([]byte(fields[10])))
	appendErrorWithContext(&errs, "PV2", s.PV2.UnmarshalText([]byte(fields[11])))
	appendErrorWithContext(&errs, "PV3", s.PV3.UnmarshalText([]byte(fields[12])))
	appendErrorWithContext(&errs, "MEAN_FCST", s.MEAN_FCST.UnmarshalText([]byte(fields[13])))
	appendErrorWithContext(&errs, "MEAN_OBS", s.MEAN_OBS.UnmarshalText([]byte(fields[14])))
	appendErrorWithContext(&errs, "SEEPS", s.SEEPS.UnmarshalText([]byte(fields[15])))
	return errors.Join(errs...)
}
...
func (s *STAT_VAL1L2_data) fill(fields []string) error {
	...
	appendErrorWithContext(&errs, "FA_SPEED_BAR", s.FA_SPEED_BAR.UnmarshalText([]byte(fields[8])))
	appendErrorWithContext(&errs, "OA_SPEED_BAR", s.OA_SPEED_BAR.UnmarshalText([]byte(fields[9])))
	appendErrorWithContext(&errs, "TOTAL_DIR", s.TOTAL_DIR.UnmarshalText([]byte(fields[10])))
	appendErrorWithContext(&errs, "DIRA_ME", s.DIRA_ME.UnmarshalText([]byte(fields[11])))
	appendErrorWithContext(&errs, "DIRA_MAE", s.DIRA_MAE.UnmarshalText([]byte(fields[12])))
	appendErrorWithContext(&errs, "DIRA_MSE", s.DIRA_MSE.UnmarshalText([]byte(fields[13])))
	return errors.Join(errs...)
}
...
func (s *STAT_VCNT_data) fill(fields []string) error {
	...
	appendErrorWithContext(&errs, "ANOM_CORR", s.ANOM_CORR.UnmarshalText([]byte(fields[55])))
	appendErrorWithContext(&errs, "ANOM_CORR_NCL", s.ANOM_CORR_NCL.UnmarshalText([]byte(fields[56])))
	appendErrorWithContext(&errs, "ANOM_CORR_NCU", s.ANOM_CORR_NCU.UnmarshalText([]byte(fields[57])))
	appendErrorWithContext(&errs, "ANOM_CORR_BCL", s.ANOM_CORR_BCL.UnmarshalText([]byte(fields[58])))
	appendErrorWithContext(&errs, "ANOM_CORR_BCU", s.ANOM_CORR_BCU.UnmarshalText([]byte(fields[59])))
	appendErrorWithContext(&errs, "ANOM_CORR_UNCNTR", s.ANOM_CORR_UNCNTR.UnmarshalText([]byte(fields[60])))
	appendErrorWithContext(&errs, "ANOM_CORR_UNCNTR_BCL", s.ANOM_CORR_UNCNTR_BCL.UnmarshalText([]byte(fields[61])))
	appendErrorWithContext(&errs, "ANOM_CORR_UNCNTR_BCU", s.ANOM_CORR_UNCNTR_BCU.UnmarshalText([]byte(fields[62])))
	appendErrorWithContext(&errs, "TOTAL_DIR", s.TOTAL_DIR.UnmarshalText([]byte(fields[63])))
	appendErrorWithContext(&errs, "DIR_ME", s.DIR_ME.UnmarshalText([]byte(fields[64])))
	appendErrorWithContext(&errs, "DIR_ME_BCL", s.DIR_ME_BCL.UnmarshalText([]byte(fields[65])))
	appendErrorWithContext(&errs, "DIR_ME_BCU", s.DIR_ME_BCU.UnmarshalText([]byte(fields[66])))
	appendErrorWithContext(&errs, "DIR_MAE", s.DIR_MAE.UnmarshalText([]byte(fields[67])))
	appendErrorWithContext(&errs, "DIR_MAE_BCL", s.DIR_MAE_BCL.UnmarshalText([]byte(fields[68])))
	appendErrorWithContext(&errs, "DIR_MAE_BCU", s.DIR_MAE_BCU.UnmarshalText([]byte(fields[69])))
	appendErrorWithContext(&errs, "DIR_MSE", s.DIR_MSE.UnmarshalText([]byte(fields[70])))
	appendErrorWithContext(&errs, "DIR_MSE_BCL", s.DIR_MSE_BCL.UnmarshalText([]byte(fields[71])))
	appendErrorWithContext(&errs, "DIR_MSE_BCU", s.DIR_MSE_BCU.UnmarshalText([]byte(fields[72])))
	appendErrorWithContext(&errs, "DIR_RMSE", s.DIR_RMSE.UnmarshalText([]byte(fields[73])))
	appendErrorWithContext(&errs, "DIR_RMSE_BCL", s.DIR_RMSE_BCL.UnmarshalText([]byte(fields[74])))
	appendErrorWithContext(&errs, "DIR_RMSE_BCU", s.DIR_RMSE_BCU.UnmarshalText([]byte(fields[75])))
	return errors.Join(errs...)
}
...
func (s *STAT_VL1L2_data) fill(fields []string) error {
	...
	appendErrorWithContext(&errs, "TOTAL_DIR", s.TOTAL_DIR.UnmarshalText([]byte(fields[10])))
	appendErrorWithContext(&errs, "DIR_ME", s.DIR_ME.UnmarshalText([]byte(fields[11])))
	appendErrorWithContext(&errs, "DIR_MAE", s.DIR_MAE.UnmarshalText([]byte(fields[12])))
	appendErrorWithContext(&errs, "DIR_MSE", s.DIR_MSE.UnmarshalText([]byte(fields[13])))
	return errors.Join(errs...)
}
...
func (s *TCST_TCDIAG_data) fill(fields []string) error {
	var errs []error
	appendErrorWithContext(&errs, "TOTAL", s.TOTAL.UnmarshalText([]byte(fields[0])))
	appendErrorWithContext(&errs, "INDEX", s.INDEX.UnmarshalText([]byte(fields[1])))
	appendErrorWithContext(&errs, "DIAG_SOURCE", s.DIAG_SOURCE.UnmarshalText([]byte(fields[2])))
	appendErrorWithContext(&errs, "TRACK_SOURCE", s.TRACK_SOURCE.UnmarshalText([]byte(fields[3])))
	appendErrorWithContext(&errs, "FIELD_SOURCE", s.FIELD_SOURCE.UnmarshalText([]byte(fields[4])))
	// the first field of the repeating fields is the TOTAL, the second field is the 1st dimenSion of the 1st sequence (there might be only one sequence)
	...
	for group := 1; group <= count; group++ {
		for index := 6; index <= len(keyPrefixes); index++ {
			...
			if index > len(fields) { // sometimes the data line is truncated - invalidate that field
				...
				appendErrorWithContext(&errs, "DIAG", value.UnmarshalText([]byte(fields[index])))
			}
			s.DIAG[key] = value
		}
	}
	appendErrorWithContext(&errs, "INIT", s.INIT.UnmarshalText([]byte(fields[8])))
	return errors.Join(errs...)
}
...
func (s *TCST_TCMPR_data) fill(fields []string) error {
	...
	appendErrorWithContext(&errs, "NUM_MEMBERS", s.NUM_MEMBERS.UnmarshalText([]byte(fields[66])))
	appendErrorWithContext(&errs, "TRACK_SPREAD", s.TRACK_SPREAD.UnmarshalText([]byte(fields[67])))
	appendErrorWithContext(&errs, "TRACK_STDEV", s.TRACK_STDEV.UnmarshalText([]byte(fields[68])))
	appendErrorWithContext(&errs, "MSLP_STDEV", s.MSLP_STDEV.UnmarshalText([]byte(fields[69])))
	appendErrorWithContext(&errs, "MAX_WIND_STDEV", s.MAX_WIND_STDEV.UnmarshalText([]byte(fields[70])))
	appendErrorWithContext(&errs, "INIT", s.INIT.UnmarshalText([]byte(fields[71])))
	return errors.Join(errs...)
}
...
func NewDocForId(fileLineType string, metaData mettypes.VxMetadata, headerData []string, dataData []string, dataKey string) (mettypes.METdocument, error) {
	...
	case "MTD_2DSINGLE":
		...
		appendErrorWithContext(&errs, "MTD_2DSINGLE_header", elem_header.fill(headerData))
		elem_data := MTD_2DSINGLE_data{}
		appendErrorWithContext(&errs, "MTD_2DSINGLE_data", elem_data.fill(dataData))
	...
	case "MTD_3DPAIR":
		...
		appendErrorWithContext(&errs, "MTD_3DPAIR_header", elem_header.fill(headerData))
		elem_data := MTD_3DPAIR_data{}
		appendErrorWithContext(&errs, "MTD_3DPAIR_data", elem_data.fill(dataData))
	...
	case "MTD_3DSINGLE":
		...
		appendErrorWithContext(&errs, "MTD_3DSINGLE_header", elem_header.fill(headerData))
		elem_data := MTD_3DSINGLE_data{}
		appendErrorWithContext(&errs, "MTD_3DSINGLE_data", elem_data.fill(dataData))
