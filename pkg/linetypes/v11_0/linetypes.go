...
func (s *STAT_SEEPS_data) fill(fields []string) {
	s.TOTAL.UnmarshalText([]byte(fields[0]))
	s.S12.UnmarshalText([]byte(fields[1]))
	s.S13.UnmarshalText([]byte(fields[2]))
	s.S21.UnmarshalText([]byte(fields[3]))
	s.S23.UnmarshalText([]byte(fields[4]))
	s.S31.UnmarshalText([]byte(fields[5]))
	s.S32.UnmarshalText([]byte(fields[6]))
