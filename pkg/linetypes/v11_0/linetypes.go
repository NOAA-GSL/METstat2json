...
type STAT_SEEPS_data struct {
	TOTAL     validtypes.ValidInt    `json:"TOTAL,omitzero"`
	S12       validtypes.ValidString `json:"S12,omitzero"`
	S13       validtypes.ValidString `json:"S13,omitzero"`
	S21       validtypes.ValidString `json:"S21,omitzero"`
	S23       validtypes.ValidString `json:"S23,omitzero"`
	S31       validtypes.ValidString `json:"S31,omitzero"`
	S32       validtypes.ValidString `json:"S32,omitzero"`
...
func (s *STAT_SEEPS_data) fill(fields []string) error {
	var errs []error
	appendErrorWithContext(&errs, "TOTAL", s.TOTAL.UnmarshalText([]byte(fields[0])))
	appendErrorWithContext(&errs, "S12", s.S12.UnmarshalText([]byte(fields[1])))
	appendErrorWithContext(&errs, "S13", s.S13.UnmarshalText([]byte(fields[2])))
	appendErrorWithContext(&errs, "S21", s.S21.UnmarshalText([]byte(fields[3])))
	appendErrorWithContext(&errs, "S23", s.S23.UnmarshalText([]byte(fields[4])))
	appendErrorWithContext(&errs, "S31", s.S31.UnmarshalText([]byte(fields[5])))
	appendErrorWithContext(&errs, "S32", s.S32.UnmarshalText([]byte(fields[6])))
